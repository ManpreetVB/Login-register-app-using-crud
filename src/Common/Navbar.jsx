        ...
        <span className='navbar-brand'>Router Demo</span>
        {
            loggedUser && (
                <>
                    ...
                    <Link to="/department-master" className='btn btn-outline-light me-2'> Department Master </Link>
                    <Link to="/employee-master" className='btn btn-outline-light me-2'> Manage Employees </Link>
